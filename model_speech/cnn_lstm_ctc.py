...
#-----------------------------------------------------------------------------------------test-----------<<<<
        ...
        self.inputs = Input(name='the_inputs', shape=(None, 32, 1))
        ...
        self.h8 = LSTM(256, activation='relu', use_bias=True, return_sequences=True)(self.h7)
        self.h9 = Dropout(0.2)(self.h8)
        self.h10 = LSTM(256, activation='relu', use_bias=True, return_sequences=True)(self.h9)
        self.h11 = Dropout(0.2)(self.h10)
        #print(self.h7.shape)
        self.outputs = dense(self.vocab_size, activation='softmax')(self.h11)
...
'''
        tyar=tf.trainable_variables()
        for vart in tyar[:-9]:
            vart.trainable=False
'''
# ============================模型组件=================================
def conv2d(size):
